...
- `CONTAINER_URL`: Container registry URL (e.g., "icr.io/ibmaiu_internal/ppc64le/dd2/spyre-ubi9")
- `CONTAINER_TAG`: Container image tag (e.g., "3.5.0-ea.1-1780065632")
...
senlib:
    vms:
        - senlib:
            ...
            MEMORY: "200G"
            SHM_SIZE: "2G"
            CONTAINER_URL: "icr.io/ibmaiu_internal/ppc64le/dd2/spyre-ubi9"
            CONTAINER_TAG: "3.5.0-ea.1-1780065632"
